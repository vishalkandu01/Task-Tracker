...
function Todo() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/api/getTodoList')
            .then(result => {
    ...
    const addTask = (e) => {
        ...
        axios.post('http://localhost:8000/api/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('http://localhost:8000/api/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('http://localhost:8000/api/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
